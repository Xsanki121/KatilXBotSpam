RAID = [
    "MADARCHOD TERI MAA KI CHUT ME 𝐑𝐚𝐣𝐧𝐢𝐠𝐡𝐚𝐧𝐝𝐡𝐚 KHAAKE THOOK DUNGA 🤣🤣",
    ...
    "BHOSDIKE !! AGAR [𝐊𝐚𝐭𝐢𝐥](t.me/KatilXSpam) SE LEGA PANGA TO BEECH BAZAAR KAR DUNGA TERI MAA BHEN KO NANGA 🔥😈😈",
    "[𝐊𝐚𝐭𝐢𝐥](t.me/KatilXSpam) SE CHUD GAYA 🔥😂😂",
...
REPLYRAID = [
    ...
    "[𝐊𝐚𝐭𝐢𝐥](t.me/TERA_BAAP_KATIL) TERA BAAP !!",
    "CHUD GYA PAPA SEEE",
    "KISAN KO KHODNA OR",
